...
int main() {
    ...
    // Prompt for the total number of processes
    ...
    // Prompt for the total number of resources to allocate
    printf("\nEnter The Total Number Of Resources To Allocate:\t");
    scanf("%d", &resource);

    // Prompt for the claim vector
    printf("\nEnter The Claim Vector:\t");
    for (m = 0; m < resource; m++) {
        scanf("%d", &maximum_resources[m]);
    }

    // Prompt for the allocated resource table
    ...
    // Prompt for the maximum claim table
